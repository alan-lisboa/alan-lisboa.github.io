        ...
        <div className="absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg border border-gray-100 z-50">
          {languages.map((language) => (
            <button
              ...
              className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-50 transition-colors duration-200 first:rounded-t-lg last:rounded-b-lg ${i18n.language === language.code ? 'text-portfolio-blue font-medium' : 'text-portfolio-dark'
                }`}
            >
